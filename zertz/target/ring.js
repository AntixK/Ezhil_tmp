...
var __name__ = 'ring';
export var Ring =  __class__ ('Ring', [object], {
	__module__: __name__,
	...
	get _ring_params () {return __get__ (this, function (self, x, y, radius, colour) {
		if (typeof colour == 'undefined' || (colour != null && colour.hasOwnProperty ("__kwargtrans__"))) {;
			var colour = 245;
		};
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
